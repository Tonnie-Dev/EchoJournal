...
class HomeViewModel
    ...
    constructor(
            ...
            repository.getEchos().combine(filteredEchoes) { echoes, currentlyFilteredEchoes ->
                ...
                val sortedEchoes =
                    if (currentlyFilteredEchoes != null && currentlyFilteredEchoes.isEmpty()) {
                        ...
                        currentlyFilteredEchoes ?: emptyMap()
                    }
        ...
        private fun addNewTopicFilterItems(topics: List<String>): List<FilterState.FilterItem> {
            val currentTopics =
                currentState.filterState.topicFilterItems.map {
                    it.title
                }
        ...
        private fun updatePlayerStateAction(
            echoId: Long,
            mode: Mode,
        ) {
        ...
        private fun updatePlayerState(
            ...
            val updatedEchoes =
                currentState.echoes.mapValues { (_, echoesList) ->
        ...
        private fun updatePlayerSateCurrentPosition(
            ...
            val updatedPlayerState =
                echoHolderState.playerState.copy(
        ...
        private fun selectMoodItem(title: String) {
            val updatedMoodItems =
                currentState.filterState.moodFilterItems
                    .map {
